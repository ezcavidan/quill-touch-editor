...
export const translations: Translations = {
  en: {
    ...
    'create.description': 'Select a programming language to get started',
    'create.details.title': 'Project Details',
    'create.details.subtitle': 'Give your project a name',
    'create.selectedLanguage': 'Selected Language',
    'create.changeLanguage': 'Change Language',
  ...
  az: {
    ...
    'create.description': 'Başlamaq üçün proqramlaşdırma dili seçin',
    'create.details.title': 'Layihə Təfərrüatları',
    'create.details.subtitle': 'Layihənizə ad verin',
    'create.selectedLanguage': 'Seçilmiş Dil',
    'create.changeLanguage': 'Dili Dəyiş',
  ...
  tr: {
    ...
    'create.language': 'Dil Seçin',
    'create.description': 'Başlamak için bir programlama dili seçin',
    'create.details.title': 'Proje Detayları',
    'create.details.subtitle': 'Projenize bir isim verin',
    'create.selectedLanguage': 'Seçilen Dil',
    'create.changeLanguage': 'Dili Değiştir',
